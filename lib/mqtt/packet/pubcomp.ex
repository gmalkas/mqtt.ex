defmodule MQTT.Packet.Pubcomp do
  ...
  defp decode_reason_code(data, _), do: PacketDecoder.decode_reason_code(:pubcomp, data)

  defp decode_properties(data, 2), do: {:ok, [], 0, data}
  defp decode_properties(data, _), do: PacketDecoder.decode_properties(data)
end

defmodule MQTT.Packet.Pubcomp.Properties do
